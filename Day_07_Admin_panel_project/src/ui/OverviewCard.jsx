...
const OverviewCard = ({cash=false,icon, number, title }) => {
  return (
    <div className=" bg-rose-100/10 backdrop-blur-2xl p-5 gap-3 transition  min-w-40 duration-300 ease-in-out grow hover:shadow-md flex flex-col rounded-lg w-fit">
